      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 text-center">
          <div class="inner-column">
            <h1>@lang('Nombre de la Escuela Validada') <span> {{ $data['name']}}</span></h1>
            <h4></h4>
            <p>@lang('RUC:') {{ $data['ruc']}} </p>
            <p>@lang('Direccion:') {{ $data['address']}} </p>
            <p>@lang('Ubicacion:') {{ $data['departament'] .' / '.
          $data['province'].' / '.$data['city']}} </p>
          <p>@lang('Telefono:') 950 701 095 </p>
            
            <a class="btn btn-lg btn-circle btn-outline-new-white" href="{{url('/school/busqueda')}}">@lang('Retornar')</a>
          </div>
        </div>
