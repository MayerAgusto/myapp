						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" class="form-control" id="name" name="name" placeholder="Your Name"  value = "{{$data->name}}" required data-error="Ingrese su nombre">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									placeholder="RUC" value ="{{$data->ruc}}" required data-error="Ingresa su numero RUC">
									<div class="help-block with-errors"></div>
								</div> 
							</div>
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" class="form-control" id="address" name="address" placeholder="Direccion"  value="{{$data->address}}" required data-error="Ingrese su direccion">
									<div class="help-block with-errors"></div>
								</div>                                 
							</div>
							<div class="col-md-12">
